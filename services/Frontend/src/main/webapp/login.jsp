...
<span class="state">Already booked</span>
<% } else { %>
<span class="state">Available to book</span>
<% } %>
</div>
</div>
<% if (!appointment.booking()) { %>
...
<button type="submit" name="code" value="<%=escape(appointment.getId())%>">Book</button>
</form>
<% } else { %>
...
<section class="panel">
<h2>Account</h2>
<p class="account-name">Signed in as <%=escape(request.getAttribute("username"))%>
</p>
<p>Select Book beside an available appointment.</p>
<div class="demo">Demo account<br>Sessions last up to 30 minutes.</div>
</section>
</aside>
</div>
</main>
